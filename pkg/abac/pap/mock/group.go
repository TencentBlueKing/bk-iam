...
// ListGroupSubjectBeforeExpiredAtBySubjects mocks base method.
func (m *MockGroupController) ListGroupSubjectBeforeExpiredAtBySubjects(subjects []pap.Subject, expiredAt int64) ([]pap.GroupSubject, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListGroupSubjectBeforeExpiredAtBySubjects", subjects, expiredAt)
	ret0, _ := ret[0].([]pap.GroupSubject)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListGroupSubjectBeforeExpiredAtBySubjects indicates an expected call of ListGroupSubjectBeforeExpiredAtBySubjects.
func (mr *MockGroupControllerMockRecorder) ListGroupSubjectBeforeExpiredAtBySubjects(subjects, expiredAt interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListGroupSubjectBeforeExpiredAtBySubjects", reflect.TypeOf((*MockGroupController)(nil).ListGroupSubjectBeforeExpiredAtBySubjects), subjects, expiredAt)
}

// ListPagingGroupMember mocks base method.
func (m *MockGroupController) ListPagingGroupMember(_type, id string, limit, offset int64, ordering string) ([]pap.GroupMember, error) {
	ret := m.ctrl.Call(m, "ListPagingGroupMember", _type, id, limit, offset, ordering)
...
func (mr *MockGroupControllerMockRecorder) ListPagingGroupMember(_type, id, limit, offset, ordering interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPagingGroupMember", reflect.TypeOf((*MockGroupController)(nil).ListPagingGroupMember), _type, id, limit, offset, ordering)
}
...
// ListSubjectGroupDetails mocks base method.
func (m *MockGroupController) ListSubjectGroupDetails(_type, id string, groupIDs []string) ([]pap.SubjectGroup, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListSubjectGroupDetails", _type, id, groupIDs)
	ret0, _ := ret[0].([]pap.SubjectGroup)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListSubjectGroupDetails indicates an expected call of ListSubjectGroupDetails.
func (mr *MockGroupControllerMockRecorder) ListSubjectGroupDetails(_type, id, groupIDs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListSubjectGroupDetails", reflect.TypeOf((*MockGroupController)(nil).ListSubjectGroupDetails), _type, id, groupIDs)
}
