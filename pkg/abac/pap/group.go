...
type GroupController interface {
	...
	ListPagingGroupMember(_type, id string, limit, offset int64, isSorted bool, sortType string) ([]GroupMember, error)
...
func (c *groupController) ListPagingGroupMember(_type, id string, limit, offset int64, isSorted bool, sortType string) ([]GroupMember, error) {
	...
	svcMembers, err := c.service.ListPagingGroupMember(groupPK, limit, offset, isSorted, sortType)
	if err != nil {
		return nil, errorWrapf(
