...
func (m *MockPolicyManager) ListBySubjectAction(system string, subject types.Subject, action types.Action, effectGroupPKs []int64, withoutRbacPolicies, withoutCache bool, entry *debug.Entry) ([]types.AuthPolicy, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListBySubjectAction", system, subject, action, effectGroupPKs, withoutRbacPolicies, withoutCache, entry)
...
func (mr *MockPolicyManagerMockRecorder) ListBySubjectAction(system, subject, action, effectGroupPKs, withoutRbacPolicies, withoutCache, entry interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListBySubjectAction", reflect.TypeOf((*MockPolicyManager)(nil).ListBySubjectAction), system, subject, action, effectGroupPKs, withoutRbacPolicies, withoutCache, entry)
}
