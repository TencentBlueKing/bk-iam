...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/systems/{system_id}/actions/{action_id}": {
            "put": {
                "security": [
                    {
                        "AppCode": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/iam_pkg_api_model_handler.resourceTypeSerializer"
                            }
                        }
                    }
                ],
        ...
        "/api/v2/policy/systems/{system_id}/auth_by_actions/": {
            "post": {
                ...
                "summary": "batch auth by actions/批量鉴权接口",
                "operationId": "api-v2-policy-batch-auth-by-actions",
                "parameters": [
                    {
                        "description": "the batch auth by actions request",
                        "name": "body",
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.authV2ByActionsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v2/policy/systems/{system_id}/query_by_actions/": {
            "post": {
                ...
                "operationId": "api-v2-policy-batch-query-by-actions",
                "parameters": [
                    {
                        "description": "the batch query by action request",
                        "name": "body",
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.queryV2ByActionsRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handler.authV2ByActionsRequest": {
            "type": "object",
            "required": [
                "actions",
                "resources",
        ...
        "handler.queryV2ByActionsRequest": {
            "type": "object",
            "required": [
                "actions",
                "subject"
        ...
        "iam_pkg_api_model_handler.resourceTypeSerializer": {
            "type": "object",
            "required": [
                "id",
                "name",
